            ...
            <AnimateOnScroll>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center lg:items-start gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-8 py-4 font-semibold text-sm tracking-wide uppercase rounded-xl border border-[var(--whatsapp)]/40 text-[var(--whatsapp)] hover:bg-[var(--whatsapp)]/10 transition-all duration-300"
                >
